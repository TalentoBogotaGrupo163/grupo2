...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { body: @notice.body, date: @notice.date, image: @notice.image, tittle: @notice.tittle } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { body: @notice.body, date: @notice.date, image: @notice.image, tittle: @notice.tittle } }
