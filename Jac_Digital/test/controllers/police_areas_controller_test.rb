...
class PoliceAreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create police_area" do
    assert_difference('PoliceArea.count') do
      post police_areas_url, params: { police_area: { area_name: @police_area.area_name, id_area: @police_area.id_area, phone_id: @police_area.phone_id } }
    end
  ...
  test "should update police_area" do
    patch police_area_url(@police_area), params: { police_area: { area_name: @police_area.area_name, id_area: @police_area.id_area, phone_id: @police_area.phone_id } }
