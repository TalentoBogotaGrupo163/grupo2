...
class NetworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create network" do
    assert_difference('Network.count') do
      post networks_url, params: { network: { company_id: @network.company_id, name: @network.name, url: @network.url } }
    end
  ...
  test "should update network" do
    patch network_url(@network), params: { network: { company_id: @network.company_id, name: @network.name, url: @network.url } }
